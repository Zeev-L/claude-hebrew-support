...
# Single source of truth: the RTL detection payload lives in ../shared and is
# shared with the web userscript build. (Falls back to a local copy if present.)
if [ -f "$SCRIPT_DIR/../shared/rtl-payload.js" ]; then
    PAYLOAD_FILE="$SCRIPT_DIR/../shared/rtl-payload.js"
else
